  ...
  <div class="c-login">
    <div class="o-container">
      <div class="c-login__content">
        <form action="misc/create.php" method="post">
          <h3>Username</h3>
          <input class="c-login__input" type="text" name="username">
          <h3>Name</h3>
          <input class="c-login__input" type="text" name="name"><br>
          <h3>Password</h3>
          <input class="c-login__input" type="password" name="password"><br>
          <h3>Repeat Password</h3>
          <input class="c-login__input" type="password" name="password2"><br>
          <button class="c-login__btn" href="sklep" name="loginBtn">Register</button>
        </form>
      </div>
    </div>
  </div>
