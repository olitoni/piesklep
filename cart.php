  ...
  <div class="c-panel">
    <div class="o-container">
      <form action="cart.php" method="post">
        ...
        $total = 0;
        $id = $_SESSION['id'];
        $query = "SELECT carts.id, carts.count, carts.product, products.name, products.image, products.price FROM `carts` INNER JOIN products ON carts.product = products.id WHERE user = $id;";
