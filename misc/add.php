...
<body>
  ...
  <div class="c-panel">
    <div class="o-container">
      <form action="/misc/add.php" method="post" enctype="multipart/form-data">
        <h3>Name</h3>
        <input class="c-login__input" type="text" name="name">
        <h3>Description</h3>
        <input class="c-login__input" id="mytextarea" type="textarea" name="desc"><br>
        <h3>Image</h3>
        <input class="c-login__input" type="file" name="file" id="file" accept="image/*" onchange="handleFileSelect(event);"><br>
        <img id='img' src="" style="margin-top: 10px;" width="300px" height="150px"></img>
        <h3>Price</h3>
        <input class="c-login__input" type="number" name="price"><br>
        <h3>Review</h3>
        <input class="c-login__input" type="number" name="review"><br>
        <button class="c-login__btn" name="add" value="1">Add</button>
      </form>
    </div>
  </div>
